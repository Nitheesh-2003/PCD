...
/*
Prompt the user for the number of productions.
Prompt the user for the number of non terminals and number of terminals. 
Prompt the user for the non terminals and the terminal. 
Prompt the user for the productions of the grammar. 
Compute augmented grammar for the given grammar. 
Compute LR(0) items for the given grammar. 
Compute follow pass of non terminals present in the LHS of theproductions.
Define the function action which specifies the action to be performedforagiven state and a given terminal. 
Define the function goto which specifies the next state to bevisitedforagiven state and a given non terminal. 
Display the values of the functions action and goto for all statesandforall
